...
function SuccessfulUpload({ users, credentails, goBack }: UploadProps) {
    return (
        <div className="min-h-screen bg-gray-50 p-3">
            <div className="max-w-2xl mx-auto">
                        ...
                        <div className="flex items-center gap-3 mb-4 w-full">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-[#18AB00]">
                                    {users} users have been successfully onboarded to the RescueTap app with automatic
                                    login credentials
                                </div>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
                    ...
                    <Card className={"rounded font-lato"}>
                        <CardContent className="p-4 text-center">
                            ...
                            <div className="text-2xl font-bold text-blue-600">{credentails}</div>
                ...
                <div className="flex gap-3 justify-end items-center">
                    <Button onClick={goBack} variant="outline" className="w-fit rounded">
                        Close
                    </Button>
                    <Link href={"/org/users"} passHref>
                        <Button className="max-w-fit rounded bg-[#EF4136] hover:bg-[#EF4136]/50">
                            View New Users
                            <PiEyeThin />
                        </Button>
                    </Link>
