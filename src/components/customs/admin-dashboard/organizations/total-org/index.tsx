  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
      {[1, 2, 3, 4].map((i) => (
        <Card
          key={i}
          className="rounded py-2 border shadow-none border-[#DDDDDD] bg-white"
        >
...
function Oraganizations() {
  const { organizations, analytics, loadingOrganizations, loadingAnalytics } =
    useOrganization({ fetchAllOrgs: true });
