        ...
        <div className="flex items-center">
            <DropdownMenu>
                ...
                <DropdownMenuContent className="bg-white shadow-md">
                    <DropdownMenuItem className="text-green-500 cursor-pointer" onClick={() => setTimeout(() => {
                        setOpenEdit(true)
                    }, 60)}>
                ...
                <DialogContent>
                    <DialogHeader className={"px-2 border-b pb-2"}>
                        <DialogTitle className={"flex flex-row items-center gap-3 text-xl text-black"}>
                            <HiOutlineDocumentMinus size={30} color={"red"} /> Delete Tip?</DialogTitle>
                    </DialogHeader>
            ...
            <Dialog open={openEdit} onOpenChange={setOpenEdit}>
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>Make some changes to this tip and save it</DialogDescription>
                    </DialogHeader>
                    <Form {...form}>
